...
jQuery(function($) {
	...
	$(document).on('click', '#save', function(e) {
		e.preventDefault();
		var url = base_marketing_transaksi + 'serah_terima/serah_terima_proses.php',
			data = $('#form').serialize();
				
		if (confirm("Apakah data serah terima ini akan disimpan?") == false)
		{
			return false;
		}	
...
function loadData1()
{
	...
	jQuery('#tab1').load(base_marketing_transaksi + 'serah_terima/serah_terima.php', data);	
	return false;
}
...
<div id="container">
    <ul id="nav_tab">
        <li><a href="#tab1" class="active">Data Serah Terima</a></li>
    </ul>
    <div class="clear"></div>
    <div id="konten">
