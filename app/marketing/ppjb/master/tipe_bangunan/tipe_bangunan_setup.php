<div class="title-page">MASTER TIPE BANGUNAN</div>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_marketing + 'ppjb/master/tipe_bangunan/tipe_bangunan_load.php', data);
...
{
	var url =	base_marketing + 'ppjb/master/tipe_bangunan/tipe_bangunan_popup.php' + '?act=' + act + '&id=' + id;	
	setPopup(act + ' Tipe Bangunan', url, 500, 250);
