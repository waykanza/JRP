<div class="title-page">PROGRES PENERIMAAN</div>
...
jQuery(function($) {
	...
	$(document).on('click', '#excel', function(e) {
		e.preventDefault();
		location.href = base_marketing + 'kredit/pelaporan/progres_penerimaan/print_report_kuitansi.php?' + $('#form').serialize();
		return false;
	});
	
	$(document).on('click', '#print', function(e) {
		e.preventDefault();
		var url = base_marketing + 'kredit/pelaporan/progres_penerimaan/laporan_kuitansi_print.php?' + $('#form').serialize();
		open_print(url)
		return false;
	});
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_marketing + 'kredit/pelaporan/progres_penerimaan/progres_penerimaan_load.php', data);	
	return false;
}
</script>
