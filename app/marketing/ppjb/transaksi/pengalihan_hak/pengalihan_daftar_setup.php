...
<div class="title-page">DAFTAR PPJB</div>
...
<tr>
	...
	<td>
		<select name="field1" id="field1" class="wauto">
			<option value="z.NAMA_PEMBELI"> NAMA </option>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_marketing + 'ppjb/transaksi/pengalihan_hak/daftar_ppjb.php', data);
	return false;
}
