<?php
	...
	$namafile = "Daftar Pemberitahuan Perubahan Plafon "."(".date('d F Y').").doc";
...
<tr>
	...
	<th class="w10">PLAFON KPR DISETUJUI</th>
...
<?php
	...
	while( !$obj->EOF)
	{
		...
		<tr class="onclick" id="<?php echo $id; ?>"> 
			...
			<td><?php echo $TELP; ?></td>
			<td class="text-center"><?php echo to_money($obj->fields['PLAFON_KPR_DISETUJUI']); ?></td>
		</tr>
		<?php
		$obj->movenext();
	}
