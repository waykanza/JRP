...
*/
	...
	var url = base_marketing_operasional + 'persediaan_awal/reserve_persediaan_popup.php?act=' + act + '&id=' + id;
	setPopup(act + ' Reserve', url, 500, 300);
	return false;
}

function showPopup2(act, id, nm)
{
	var url = base_marketing_operasional + 'persediaan_awalreserve_persediaan/spp_popup.php' + '?act=' + act + '&id=' + id + '&nm=' + nm;
