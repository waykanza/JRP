...
jQuery(function($) {
	...
	$(document).on('click', '#save', function(e) {
		e.preventDefault();
		var url = base_marketing_transaksi + 'edit_spp_penjualan/spp_proses.php',
			data = $('#form').serialize();
...
function loadData1()
{
	...
	jQuery('#tab1').load(base_marketing_transaksi + 'edit_spp_penjualan/spp_spp.php', data);	
	return false;
}
...
function loadData2()
{
	if (popup) { popup.close(); }
	var data = jQuery('#form').serialize();
	jQuery('#tab2').load(base_marketing_transaksi + 'edit_spp_penjualan/spp_rincian_harga.php', data);	
	return false;
}
...
function loadData3()
{
	if (popup) { popup.close(); }
	var data = jQuery('#form').serialize();
	jQuery('#tab3').load(base_marketing_transaksi + 'edit_spp_penjualan/spp_rencana.php', data);	
	return false;
}
</script>
</head>
