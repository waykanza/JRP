...
jQuery(function($) {
	...
	$(document).on('click', '#excel', function(e) {
		e.preventDefault();
		location.href = base_marketing + 'ppjb/laporan/daftar_belum_ppjb/daftar_belum_ppjb_xls.php?' + $('#form').serialize();
		return false;
	});
	
	$(document).on('click', '#print', function(e) {
		e.preventDefault();
		var url = base_marketing + 'ppjb/laporan/daftar_belum_ppjb/daftar_belum_ppjb_print.php?' + $('#form').serialize();
		open_print(url)
		return false;
	});
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_marketing + 'ppjb/laporan/daftar_belum_ppjb/daftar_belum_ppjb_load.php', data);	
	return false;
}
</script>
