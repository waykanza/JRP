<div class="title-page">LAPORAN PENERIMAAN ANGSURAN</div>
...
jQuery(function($) {
	...
	$(document).on('click', '#excel', function(e) {
		e.preventDefault();
		location.href = base_marketing + 'collection_tunai/laporan/penerimaan_kwitansi/excel_penerimaan_kwitansi.php?' + $('#form').serialize();
		return false;
	});
	
	$(document).on('click', '#print', function(e) {
		e.preventDefault();
		window.open(base_marketing + 'collection_tunai/laporan/penerimaan_kwitansi/print_penerimaan_kwitansi.php?' + $('#form').serialize());
		return false;
	});
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_marketing + 'collection_tunai/laporan/penerimaan_kwitansi/penerimaan_kwitansi_load.php', data);	
	return false;
}
