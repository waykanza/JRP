<div class="title-page">VIRTUAL ACCOUNT</div>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_marketing + 'collection_tunai/transaksi/virtual_account/virtual_account_load.php', data);
	return false;
}
...
function hapusData()
{	
	var url		= base_marketing + 'collection_tunai/transaksi/virtual_account/virtual_account_proses.php?act=Hapus',
