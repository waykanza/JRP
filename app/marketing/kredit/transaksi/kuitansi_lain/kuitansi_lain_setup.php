<div class="title-page">KUITANSI LAIN-LAIN</div>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_marketing + 'kredit/transaksi/kuitansi_lain/kuitansi_lain_load.php', data);	
	return false;
}

function showPopup(act, id)
{
	var url =	base_marketing + 'kredit/transaksi/kuitansi_lain/kuitansi_lain_popup.php' + '?act=' + act + '&id=' + id;	
	setPopup('Kuitansi Lain-lain', url, 1000, 550);	
	return false;
}
</script>
