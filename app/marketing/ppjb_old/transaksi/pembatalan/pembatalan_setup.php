<div class="title-page">PEMBATALAN PPJB</div>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_marketing + 'ppjb/transaksi/pembatalan/pembatalan_load.php', data);	
	return false;
}

function showPopup(act, id)
{
	var url =	base_marketing + 'ppjb/transaksi/pembatalan/pembatalan_popup.php' + '?act=' + act + '&id=' + id;	
	setPopup(act + ' PPJB', url, 500, 230);	
	return false;
}
</script>
