<?php
	...
	$namafile = "Daftar Pembatalan Penolakan Kredit "."(".date('d F Y').").doc";
...
<tr>
	...
	<th class="w10">TANGGAL PEMBERITAHUAN PENOLAKKAN SPK</th>
</tr>
...
<?php
	...
	SELECT * FROM SPP 
	WHERE 
	(select dbo.kurang_tgl(TGL_SRT_PEMBERITAHUAN_SPK_TLK,14)) = CONVERT(DATETIME,'$tgl',105) 
	";
	...
	while( !$obj->EOF)
	{
		...
		<tr class="onclick" id="<?php echo $id; ?>"> 
			...
			<td><?php echo $TELP; ?></td>
			<td class="text-center"><?php echo tgltgl(date("d-m-Y", strtotime($obj->fields['TGL_SRT_PEMBERITAHUAN_SPK_TLK']))); ?></td>
		</tr>
		<?php
		$obj->movenext();
	}
