...
jQuery(function($) {
	...
	$(document).on('click', '#excel', function(e) {
		e.preventDefault();
		location.href = base_kredit_pelaporan + 'laporan_kuitansi/laporan_kuitansi_xls.php?' + $('#form').serialize();
		return false;
	});
	
	$(document).on('click', '#print', function(e) {
		e.preventDefault();
		var url = base_kredit_pelaporan + 'laporan_kuitansi/laporan_kuitansi_print.php?' + $('#form').serialize();
		open_print(url)
		return false;
	});
...
function loadData()
{
	...
	jQuery('#t-detail').load(this_base + 'penjualan_p_unit_load.php', data);	
	return false;
}
</script>
