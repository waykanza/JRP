...
jQuery(function($) {
	...
	$(document).on('click', '#excel', function(e) {
		e.preventDefault();
		location.href = base_marketing + 'laporan/penjualan_p_class/penjualan_p_class_xls.php?' + $('#form').serialize();
		return false;
	});
	
	$(document).on('click', '#print', function(e) {
		e.preventDefault();
		var url = base_marketing_laporan + 'penjualan_p_class/penjualan_p_class_print.php?' + $('#form').serialize();
		open_print(url)
		return false;
	});
...
function loadData()
{
	...
	jQuery('#t-data').load(base_marketing + 'laporan/penjualan_p_class/penjualan_p_class_load.php', data);	
	return false;
}
</script>
