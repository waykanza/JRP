<div class="title-page">KARTU KUNING</div>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_marketing + 'kredit/pelaporan/kartu_kuning/kartu_kuning_load.php', data);	
	return false;
}

function showPopup(act, id)
{
	var url =	base_marketing + 'kredit/pelaporan/kartu_kuning/kartu_kuning_popup.php' + '?act=' + act + '&id=' + id;	
	setPopup('Kartu Kuning', url, 1100, 550);	
	return false;
}
</script>
