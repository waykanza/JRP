<div class="title-page">LAPORAN PENJUALAN PER UNIT</div>
...
jQuery(function($) {
	...
	$(document).on('click', '#excel', function(e) {
		e.preventDefault();
		location.href = base_marketing + 'laporan/penjualan_p_lokasi/penjualan_p_lokasi_xls.php?' + $('#form').serialize();
		return false;
	});
	
	$(document).on('click', '#print', function(e) {
		e.preventDefault();
		var url = base_marketing_laporan + 'penjualan_p_lokasi/penjualan_p_lokasi_print.php?' + $('#form').serialize();
		open_print(url)
		return false;
	});
...
function loadData()
{
	...
	jQuery('#t-data').load(base_marketing + 'laporan/penjualan_p_lokasi/penjualan_p_lokasi_load.php', data);	
	return false;
}
</script>
