<?php
	...
	if($act == 'Surat') #Proses Hapus
	{
		...
		{		
			...
			$query = "select NOMOR_SURAT_KESEMPATAN_AKHIR,REG_SURAT_KESEMPATAN_AKHIR from CS_REGISTER_CUSTOMER_SERVICE";
			$obj = $conn->execute($query);
			
			$no				= 1 + $obj->fields['NOMOR_SURAT_KESEMPATAN_AKHIR'];
			$reg			= $obj->fields['REG_SURAT_KESEMPATAN_AKHIR'];
			$tahun 			= date('Y');
			...
			$namafile = "Surat Wanprestasi"."_".date('d F Y').".doc";
