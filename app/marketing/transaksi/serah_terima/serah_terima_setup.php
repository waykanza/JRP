<div class="title-page">SERAH TERIMA</div>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_marketing_transaksi + 'serah_terima/spp_load.php', data);	
	return false;
}

function showPopup(act, id)
{
	var url =	base_marketing_transaksi + 'serah_terima/serah_terima_popup.php' + '?act=' + act + '&id=' + id;
	setPopup(act + ' Serah Terima', url, 830, 550);	
	return false;
}

function hapusData()
{	
	var url		= base_marketing_transaksi + 'serah_terima/serah_terima_proses.php?act=Hapus',
