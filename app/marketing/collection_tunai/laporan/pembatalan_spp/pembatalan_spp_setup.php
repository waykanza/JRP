<div class="title-page">LAPORAN PEMBATALAN SPP</div>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_marketing + 'collection_tunai/laporan/pembatalan_spp/pembatalan_spp_load.php', data);	
	return false;
}
