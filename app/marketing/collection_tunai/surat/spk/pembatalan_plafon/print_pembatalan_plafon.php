<?php
	...
	$namafile = "Daftar Pembatalan Perubahan Plafon "."(".date('d F Y').").doc";
...
<?php
	...
	while( !$obj->EOF)
	{
		...
		<tr class="onclick" id="<?php echo $id; ?>"> 
			...
			<td><?php echo $TELP; ?></td>
			<td class="text-center"><?php echo tgltgl(date("d-m-Y", strtotime($obj->fields['TGL_SRT_PERUBAHAN_PLAFON']))); ?></td>
		</tr>
		<?php
		$obj->movenext();
	}
