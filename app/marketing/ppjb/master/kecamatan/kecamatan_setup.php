<div class="title-page">MASTER KECAMATAN</div>
...
<tr>
	...
	<td>
		<select name="field1" id="field1" class="wauto">
			<option value="KODE_KECAMATAN"> KODE </option>
			<option value="NAMA_KECAMATAN"> NAMA </option>
		</select>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_marketing + 'ppjb/master/kecamatan/kecamatan_load.php', data);	
	return false;
}

function showPopup(act, id)
{
	var url =	base_marketing + 'ppjb/master/kecamatan/kecamatan_popup.php' + '?act=' + act + '&id=' + id;	
	setPopup(act + ' Kecamatan', url, 450, 200);
	return false;
}

function hapusData()
{
	var url		= base_marketing + 'ppjb/master/kecamatan/kecamatan_proses.php?act=Hapus',
