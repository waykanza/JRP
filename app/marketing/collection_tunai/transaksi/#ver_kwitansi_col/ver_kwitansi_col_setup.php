<div class="title-page">VERIFIKASI KWITANSI (BIRO COLLECTION)</div>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_marketing + 'collection_tunai/transaksi/ver_kwitansi_col/ver_kwitansi_col_load.php', data);	
	return false;
}
...
function verData()
{
	...
	var url		= base_marketing + 'collection_tunai/transaksi/ver_kwitansi_col/ver_kwitansi_col_proses.php',
