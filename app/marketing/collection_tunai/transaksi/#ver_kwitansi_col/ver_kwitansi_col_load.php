...
if ($periode_awal <> '' || $periode_akhir <> '')
{
	...
	if ($field1 <> '')
	{
		$query_search2 .= "AND NOMOR_KWITANSI LIKE '%$search1%' ";
	}
...
<tr>
	...
	<th class="w5">COLLECTION<input type="checkbox" id="cb_all"></th>
	<th class="w5">KEUANGAN</th>
</tr>
<?php
}
	...
	while( ! $obj->EOF)
	{
		...
		<tr class="onclick" id="<?php echo $id; ?>"> 
			...
			<td class="text-center">
				<input type="checkbox" name="cb_data[]" value=<?php echo $id; ?> class="cb_data" <?php echo is_checked('1', $obj->fields['VER_COLLECTION']); ?>>
			</td>
