...
<?php
	$query = "
	SELECT a.NOMOR_KWITANSI, a.TANGGAL, a.NAMA_PEMBELI, a.KETERANGAN, a.JUMLAH_DITERIMA FROM 
KWITANSI_TANDA_TERIMA a LEFT JOIN SPP s ON a.KODE_BLOK = s.KODE_BLOK

	WHERE a.KODE_BLOK = '$id' AND a.BAYAR_UNTUK NOT IN (1)
	";
	...
	while( ! $obj->EOF)
	{
		...
		<tr class="onclick" id="<?php echo $id; ?>">		
			...
			<td class="text-right"><?php echo to_money($obj->fields['JUMLAH_DITERIMA']);  ?></td>
