...
function loadData()
{
	...
	jQuery('#t-detail').load(base_marketing + 'collection_tunai/informasi_pembeli/informasi_pembeli_load.php', data);	
	return false;
}

function showPopup(act, id)
{
	var url =	base_collection_tunai_master + 'informasi_pembeli/informasi_pembeli_popup.php' + '?act=' + act + '&id=' + id;
...
function hapusData()
{	
	var url		= base_collection_tunai_master + 'informasi_pembeli/informasi_pembeli_proses.php?act=Hapus',
