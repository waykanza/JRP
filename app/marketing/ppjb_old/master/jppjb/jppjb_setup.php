<div class="title-page">MASTER JENIS PPJB</div>
...
<tr>
	...
	<td>
		<select name="field1" id="field1" class="wauto">
			...
			<option value="NAMA_JENIS"> JENIS PPJB </option>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_marketing + 'ppjb/master/jppjb/jppjb_load.php', data);
	return false;
}

function showPopup(act, id)
{
	var url =	base_marketing + 'ppjb/master/jppjb/jppjb_popup.php' + '?act=' + act + '&id=' + id;
	setPopup(act + ' Jenis PPJB', url, 500, 200);	
	return false;
}

function hapusData()
{
	var url		= base_marketing + 'ppjb/master/jppjb/jppjb_proses.php?act=Hapus',
