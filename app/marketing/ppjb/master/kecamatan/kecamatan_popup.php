<?php
require_once('kecamatan_proses.php');
?>
...
$(function() {	
	$('#kode_kecamatan').inputmask('numeric', { repeat: '3' });
	$('#nama_kecamatan').inputmask('varchar', { repeat: '40' });
	...
	$('#save').on('click', function(e) {
		e.preventDefault();
		var url		= base_marketing + 'ppjb/master/kecamatan/kecamatan_proses.php',
			data	= $('#form').serialize();
