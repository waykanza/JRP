<?php
	...
	$kode_jenis_addendum	= (isset($_REQUEST['kode_jenis_addendum'])) ? $_REQUEST['kode_jenis_addendum'] : '';
	...
	//query JENIS ADDENDUM
	$query = "
	SELECT KODE_JENIS
	,NAMA_JENIS
	,NAMA_FILE
	FROM CS_JENIS_PPJB_ADDENDUM
	WHERE KODE_JENIS = '$kode_jenis_addendum'
	";
	$obj = $conn->execute($query);
