...
<html>
	...
	<body onload="window.print()">
		...
		Pada hari ini <strong><?php echo $nama_pembeli; ?></strong> tanggal <strong><?php echo $tanggal; ?></strong> bulan <strong><?php echo $bulan; ?></strong> tahun <strong><?php echo $tahun; ?></strong> [<strong><?php echo $bilangan -> eja($tahun);?></strong>] yang bertandatangan dibawah ini:
