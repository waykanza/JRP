<div class="title-page">HARI LIBUR</div>
...
<tr>
	<td width="100">Keterangan</td><td width="10">:</td>
	<td>
		<input type="text" size="43" name="keterangan" id="keterangan" class="apply" value="">
	</td>
</tr>
<tr>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_marketing + 'collection_tunai/master/cs_hari_libur/cs_hari_libur_load.php', data);
	return false;
}
...
function hapusData()
{	
	var url		= base_marketing + 'collection_tunai/master/cs_hari_libur/cs_hari_libur_proses.php?act=Hapus',
