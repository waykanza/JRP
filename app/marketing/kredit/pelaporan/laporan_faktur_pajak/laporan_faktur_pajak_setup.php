<div class="title-page">DAFTAR FAKTUR PAJAK</div>
...
jQuery(function($) {
	...
	$(document).on('click', '#print', function(e) {
		e.preventDefault();
		var url = base_marketing + 'kredit/pelaporan/laporan_faktur_pajak/laporan_faktur_pajak_print.php?' + $('#form').serialize();
		open_print(url)
		return false;
	});
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_marketing + 'kredit/pelaporan/laporan_faktur_pajak/laporan_faktur_pajak_load.php', data);	
	return false;
}
</script>
