<?php
	...
	if($act == 'Surat') #Proses Hapus
	{
		...
		{		
			...
			$query = "select NOMOR_SURAT_TEGURAN_2,REG_SURAT_TEGURAN_2 from CS_REGISTER_CUSTOMER_SERVICE";
			$obj = $conn->execute($query);
			
			$no				= 1 + $obj->fields['NOMOR_SURAT_TEGURAN_2'];
			$reg			= $obj->fields['REG_SURAT_TEGURAN_2'];
			$tahun 			= date('Y');
			...
			$namafile = "Surat Somasi II"."_".date('d F Y').".doc";
