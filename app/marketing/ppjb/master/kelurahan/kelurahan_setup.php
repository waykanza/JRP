<div class="title-page">MASTER KELURAHAN</div>
...
<tr>
	...
	<td>
		<select name="field1" id="field1" class="wauto">
			<option value="KODE_KELURAHAN"> KODE </option>
			<option value="NAMA_KELURAHAN"> NAMA </option>
		</select>
...
function loadData()
{
	...
	jQuery('#t-detail').load(base_marketing + 'ppjb/master/kelurahan/kelurahan_load.php', data);
	return false;
}

function showPopup(act, id)
{
	var url =	base_marketing + 'ppjb/master/kelurahan/kelurahan_popup.php' + '?act=' + act + '&id=' + id;
	setPopup(act + ' Kelurahan', url, 450, 200);
	return false;
}

function hapusData()
{	
	var url		= base_marketing + 'ppjb/master/kelurahan/kelurahan_proses.php?act=Hapus',
