...
WHERE 
(select dbo.kurang_tgl(TGL_SRT_PEMBERITAHUAN_SPK_REV,14)) = CONVERT(DATETIME,'$tgl',105) 
";
...
<tr>
	...
	<th class="w10">TANGGAL PEMBERITAHUAN SPK REVIEW</th>
...
if ($total_data > 0)
{
	...
	while( !$obj->EOF)
	{
		...
		<tr class="onclick" id="<?php echo $id; ?>"> 
			...
			<td><?php echo $TELP; ?></td>
			<td class="text-center"><?php echo tgltgl(date("d-m-Y", strtotime($obj->fields['TGL_SRT_PEMBERITAHUAN_SPK_REV']))); ?></td>
		</tr>
		<?php
		$obj->movenext();
	}
