...
<table class="t-control2">
    <tr>
      <td style="font-size:20px;text-align:center;font-weight:bold" >Daftar Administrasi Pembatalan </td>
    </tr>
</table>	
...
jQuery(function($) {
	...
	$(document).on('click', '#print', function(e) {
		e.preventDefault();
		location.href = base_marketing + 'collection_tunai/surat/pembatalan/print_pembatalan.php?' + $('#form').serializeArray();
		return false;
	});
