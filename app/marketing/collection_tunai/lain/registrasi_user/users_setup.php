...
function loadData() {
	...
	jQuery('#data-load').load(base_collection_tunai_lain + 'registrasi_user/users_load.php', data);
	return false;
}

function showPopup(act, id) {
	var url = base_collection_tunai_lain + 'registrasi_user/users_popup.php?act=' + act + '&id=' + id;
	setPopup(act + ' User', url, 500, 300);
	return false;
}

function hapusData() {
	var url		= base_collection_tunai_lain + 'registrasi_user/users_proses.php?act=Hapus',
...
<div class="title-page">REGISTRASI USER</div>
