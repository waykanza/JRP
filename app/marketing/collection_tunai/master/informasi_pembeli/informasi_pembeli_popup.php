...
jQuery(function($) {
	...
	$(document).on('click', '#save', function(e) {
		e.preventDefault();
		var url = base_marketing+ 'collection_tunai/master/informasi_pembeli/informasi_pembeli_proses.php',
			data = $('#form').serialize();
...
function loadData1()
{
	...
	jQuery('#tab1').load(base_marketing + 'collection_tunai/master/informasi_pembeli/informasi_pembeli_spp.php', data);	
	return false;
}
...
function loadData2()
{
	if (popup) { popup.close(); }
	var data = jQuery('#form').serialize();
	jQuery('#tab2').load(base_marketing + 'collection_tunai/master/informasi_pembeli/informasi_pembeli_rencana.php', data);	
	return false;
}
...
function loadData3()
{
	if (popup) { popup.close(); }
	var data = jQuery('#form').serialize();
	jQuery('#tab3').load(base_marketing + 'collection_tunai/master/informasi_pembeli/informasi_pembeli_tt.php', data);	
	return false;
}
function loadData4()
{
	if (popup) { popup.close(); }
	var data = jQuery('#form').serialize();
	jQuery('#tab4').load(base_marketing + 'collection_tunai/master/informasi_pembeli/informasi_pembeli_kwitansi.php', data);	
	return false;
}
function loadData5()
{
	if (popup) { popup.close(); }
	var data = jQuery('#form').serialize();
	jQuery('#tab5').load(base_marketing + 'collection_tunai/master/informasi_pembeli/informasi_pembeli_kwitansilain.php', data);	
	return false;
}
</script>
</head>
...
<div id="container">
    <ul id="nav_tab">
		...
		<li><a href="#tab3">Tanda Terima</a></li>
        <li><a href="#tab4">Kwitansi</a></li>
		<li><a href="#tab5">Kwitansi Lain-lain</a></li>
    </ul>
    <div class="clear"></div>
    <div id="konten">
