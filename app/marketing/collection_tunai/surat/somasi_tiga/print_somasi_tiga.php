...
$query_pemb_jt .= "(SELECT SOMASI_TIGA FROM CS_PARAMETER_COL)";
...
$set_jrp = '
<tr><td colspan="8" class="nb text-center"><b> LAPORAN DAFTAR SURAT SOMASI III </b></td></tr>
...
<head>
<meta charset="UTF-8">
<title>LAPORAN DAFTAR SURAT SOMASI III</title>
<style type="text/css">
@media print {
	@page {
