...
var this_base = base_marketing + 'master/club_personal/';
...
function loadData() {
	...
	jQuery('#data-load').load(this_base + 'club_personal_load.php', data);
	return false;
}

function showPopup(act, id) {
	var url = this_base + 'club_personal_popup.php?act=' + act + '&id=' + id;
	setPopup(act + ' Desa', url, 700, 450);
	return false;
}
</script>

<div class="title-page">CLUB PERSONAL</div>
