...
$set_jrp = '
<tr><td colspan="8" class="nb text-center"><b> DAFTAR MEMO PEMBATALAN </b></td></tr>
...
$filename = "Daftar Memo Pembatalan " .kontgl(date("d M Y", strtotime($periode_awal))). " s/d " .kontgl(date("d M Y", strtotime($periode_akhir)));
...
<head>
<meta charset="UTF-8">
<title>DAFTAR MEMO PEMBATALAN</title>
<style type="text/css">
@media print {
	@page {
...
if ($total_data > 0)
{
	...
	while( ! $obj->EOF)
	{
		...
		<tr class="onclick" id="<?php echo $id; ?>"> 
			...
			<td class="text-center"><?php echo to_money($obj->fields['TOTAL_PENGEMBALIAN']); ?></td>
